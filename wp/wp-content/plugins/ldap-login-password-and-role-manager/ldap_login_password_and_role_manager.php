...
*/
define('LDAP_LPRM_VERSION','1.0.11');
...
function ldap_login_password_and_role_manager_admin_actions() {
  add_options_page('LDAP Settings', 'LDAP Settings', 'manage_options', 'ldap_login_password_and_role_manager', 'ldap_login_password_and_role_manager_menu');
  $newuserredir = get_option('ldap_login_password_and_role_manager_newuserredirect');
  if ( $newuserredir.'x' != 'x' ) add_users_page('LDAP Add User', 'LDAP Add User', 'manage_options', 'ldap_login_password_and_role_manager_adduser', 'ldap_login_password_and_role_manager_menu_adduser');
}
...
function ldap_login_password_and_role_manager_add_options() {
  ...
  add_option('ldap_login_password_and_role_manager_domain_controllers', 'dc1.mydomain.local');
