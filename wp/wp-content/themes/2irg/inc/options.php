...
function optionsframework_options() {
	...
	$options[] = array(
		'desc' => '<div class="infohead"><span class="donation">A Theme is an effort of many sleepless nights of the Developers.  If you like this FREEE Theme You can consider for a 5 star rating and honest review. Your review will inspire us. You can <a href="https://wordpress.org/support/view/theme-reviews/d5-business-line" target="_blank"><strong>Review Here</strong></a>.</span><br /><br /><span class="donation"> Need More Features and Options including Exciting Slides and 100+ Advanced Features with RESPONSIVE Layout? Try <a href="http://d5creation.com/theme/businessline/" target="_blank"><strong>Business Line Extend</strong></a>.</span><br /> <br /><span class="donation"> You can Visit the Business Line Extend Demo <a href="http://demo.d5creation.com/themes/?theme=Business%20Line" target="_blank"><strong>Here</strong></a>.</span></div>',
		'type' => 'info');
